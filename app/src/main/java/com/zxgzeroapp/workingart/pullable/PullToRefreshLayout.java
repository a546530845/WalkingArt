...
public class PullToRefreshLayout extends RelativeLayout {
	...
	public void loadmoreFinish(int refreshResult) {
		...
		switch (refreshResult) {
			...
			case NOMORE:
				// 没有更多信息
				loadStateImageView.setVisibility(View.VISIBLE);
				loadStateTextView.setText(R.string.refresh_nomore);
				loadStateImageView
						.setBackgroundResource(R.mipmap.allview_load_succeed);
				break;
			case FAIL:
			...
			AsyncTask<Integer, Float, String>
	{
		...
		{
//			publishProgress(4 / 3 * refreshDist);
...
//		RelativeLayout.LayoutParams mParams = new LayoutParams(
//				LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
//		mParams.addRule(RelativeLayout.CENTER_IN_PARENT);
//		mParams.leftMargin = 30;
//		mParams.rightMargin = ((MarginLayoutParams) pullableView.getLayoutParams()).rightMargin;
//		pullableView.setLayoutParams(mParams);
