...
import com.zxgzeroapp.workingart.presenter.fragment.ConsMonthFgtPresenter;
...
public class MonthFragment extends BaseFragment implements PullToRefreshLayout.OnRefreshListener,IConsMonthFgtView{
    ...
    public void setView(LayoutInflater inflater, @Nullable ViewGroup container) {
        ...
        mFgtView = inflater.inflate(R.layout.collection_month_fgt, container, false);
    }
    ...
    public void getDataFromServer() {
        ...
        mConstellationRequestBean.setType("month");
        //获取数据
        ConsMonthFgtPresenter mConsMonthFgtPresenter = new ConsMonthFgtPresenter(this);
        mConsMonthFgtPresenter.getConsTelltionMonthBack((RxAppCompatActivity)mContext,mConstellationRequestBean);
    }
    ...
    @Override
    public void ConsMonthSucess(ConsTellMonth bean) {
        isLoading = false;
        LogUtil.e("ConsTellMonth = ",bean.toString());
    ...
    @Override
    public void ConsMonthError(Throwable ex) {
        isLoading = false;
    ...
    @Override
    public void ConsMonthPrepare() {

    }

    @Override
    public void ConsMonthfinish() {
